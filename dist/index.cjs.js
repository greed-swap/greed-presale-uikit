...
var StyledToggle = styled__default['default'].div(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  align-items: center;\n  background-color: ", ";\n  border-radius: 24px;\n  box-shadow: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  height: 28px;\n  position: relative;\n  transition: background-color 200ms;\n  width: 60px;\n"], ["\n  align-items: center;\n  background-color: ", ";\n  border-radius: 24px;\n  box-shadow: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  height: 28px;\n  position: relative;\n  transition: background-color 200ms;\n  width: 60px;\n"])), function (_a) {
    ...
    return theme.colors[checked ? "primary" : "textDisabled"];
}, function (_a) {
    var theme = _a.theme;
    return theme.shadows.inset;
});
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 1024 300" }, props),
        React__default['default'].createElement("image", { width: "1024", height: "300", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, { alignItems: "center", mb: "15px" }, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Greed home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "Greed home page" }, innerLogo))));
};
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(Button, { size: "sm", variant: "tertiary", onClick: function () {
        ...
        } }, account)) : (React__default['default'].createElement(Button, { size: "sm", onClick: function () {
...
styled__default['default'].nav(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
...
var Menu = function (_a) {
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark; _a.toggleTheme; _a.langs; _a.setLang; _a.currentLang; _a.cakePriceUsd; var links = _a.links; _a.priceLink; _a.rugDocLink; _a.jagoSaferLink; _a.profile; var children = _a.children;
    var isXl = useMatchBreakpoints().isXl;
    var isMobile = isXl === false;
    var _b = React.useState(!isMobile); _b[0]; _b[1];
    var _c = React.useState(true); _c[0]; var setShowMenu = _c[1];
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(BodyWrapper, null,
            React__default['default'].createElement(Flex, { flexDirection: "column", alignItems: "center", pt: "20px", pb: "10px" },
                React__default['default'].createElement(Logo$1, { isDark: isDark, href: "https://www.greedtoken.com/" }),
                React__default['default'].createElement(UserBlock, { account: account, login: login, logout: logout })),
            React__default['default'].createElement(Inner, null, children))));
};
var templateObject_1$A, templateObject_2$b, templateObject_3$6, templateObject_4$2, templateObject_5$1;
...
var alertTypeMap = (_a$1 = {},
    ...
    _a$1);
var StyledToast = styled__default['default'].div(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n\n  ", " {\n    max-width: 400px;\n  }\n"], ["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n\n  ", " {\n    max-width: 400px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
...
var StyledToastContainer = styled__default['default'].div(templateObject_1$C || (templateObject_1$C = __makeTemplateObject(["\n  .enter,\n  .appear {\n    opacity: 0.01;\n  }\n\n  .enter.enter-active,\n  .appear.appear-active {\n    opacity: 1;\n    transition: opacity 250ms ease-in;\n  }\n\n  .exit {\n    opacity: 1;\n  }\n\n  .exit.exit-active {\n    opacity: 0.01;\n    transition: opacity 250ms ease-out;\n  }\n"], ["\n  .enter,\n  .appear {\n    opacity: 0.01;\n  }\n\n  .enter.enter-active,\n  .appear.appear-active {\n    opacity: 1;\n    transition: opacity 250ms ease-in;\n  }\n\n  .exit {\n    opacity: 1;\n  }\n\n  .exit.exit-active {\n    opacity: 0.01;\n    transition: opacity 250ms ease-out;\n  }\n"])));
...
var dark$1 = (_b = {},
    ...
    _b[TERTIARY] = __assign(__assign({}, light$1.tertiary), { border: "1px solid #489b99", background: darkColors.tertiary, backgroundActive: darkColors.tertiary, backgroundHover: darkColors.tertiary, color: darkColors.primary }),
